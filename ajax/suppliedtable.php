...
<html>
<head>
	<title>Supplied blood record</title>
    <meta charset="utf-8">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-#b13937">
  ...
  <div class="leftpart">
      <h2 style="font-size: 40px; color:#00008b;FONT-FAMILY:ROBOTO; TEXT-ALIGN :CENTER">TOTAL SUPPLIED BLOOD</h2>
  <table>
      <thead>
        <tr>
            <th>Blood Group</th>
...
$query = "SELECT bgp,sum(qty) as aadhar FROM SUPPLIED group by bgp order by sum(qty) desc";
...
<div class="rightPart">
<h2 style="font-size: 40px; color:#00008b;FONT-FAMILY:ROBOTO">DETAILS OF SUPPLIED BLOOD</h2>
<input type="text" id="searchBox-3" placeholder="Search here" style="margin-bottom:10px; margin-right:676px">
<div class="rtable">
<table id="mytable" style="float:left;background-color:#f0f8ff">
    <thead>
<tr>
    <th>Aadhar</th>
    <th>Name</th>
...
$stmt =$db->prepare("select * from SUPPLIED order by date desc");
$stmt->execute();
